...
//           <p>Connect to your real account</p>
//         </div>
//       </div>
//     </div>
//   );
...
//     setLoading(true);
//     try {
//       const data = await apiService.post('/todos', newTodo);
//       setTodos([data, ...todos]);
...
//     try {
//       const data = await apiService.put(`/todos/${id}`, { completed: !completed });
...
//     try {
//       const data = await apiService.put(`/todos/${id}`, updates);
//       setTodos(todos.map(todo => todo._id === id ? data : todo));
//       setEditingId(null);
//     } catch (err) {
//       setError(err.message || 'Failed to update task');
